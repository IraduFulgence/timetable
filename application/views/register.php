	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5" action="<?= base_url('postregister')?>" method="post">
					...
					<div class="container-login100-form-btn m-t-32">
                        ...
                        <p style="margin-left:10px;">Have account? <a href="<?= base_url()?>" style="text-decoration: none; color:green;">Login here</a></p>
