			 ...
			 <div class="row">
                    <div class="col-md-12">
						...
						<div class="hero-unit-table">   
                            ...
                            <form class="form" method="post" enctype="multipart/form-data" action="<?=base_url('addstudent')?>">
                                <div class="alert alert-info"><strong>New Student</strong> </div>
                                <hr>
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="inputPassword">Reference number</label>
                                    <div class="controls">
