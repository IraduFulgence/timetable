...
$result = $this->db->get('users')->result_array();
// echo $result[0]['role'];
    $data1['examtime'] = $this->db->where('semester',$result[0]['level'])->where('department',$result[0]['faculity'])->order_by('id', 'DESC')->get('examtime')->result_array();
